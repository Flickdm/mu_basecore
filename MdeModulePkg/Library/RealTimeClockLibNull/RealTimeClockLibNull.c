/** @file
  ...
  library class functions. LibGetTime and LibSetTime return
  EFI_UNSUPPORTED, as do the wakeup time functions. Platform code
  that does not require real-time clock hardware can link against
  this instance to satisfy the library class dependency.
